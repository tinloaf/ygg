...
using TreeA =
    RBTree<Node, NodeTraits, TreeOptions<TreeFlags::MULTIPLE>, TAG_A, CompareA>;
using TreeB =
    RBTree<Node, NodeTraits, TreeOptions<TreeFlags::MULTIPLE>, TAG_B, CompareB>;
