 ...
 * value is a string.
 */
class Node : public AvgMinTreeNodeBase<Node, MyTreeOptions> {
public:
  int key;
  std::string value;
...
using MyTree = AvgMinTree<Node, AvgMinTreeDefaultNodeTraits<Node>, MyTreeOptions>;
...
main(int argc, char ** argv)
{
  ...
  std::string retrieved_value = it->value; // *it is the Node
	...
	// This should output "We found it: The key is 3".
	std::cout << "We found it: " << retrieved_value << "\n";
